...
namespace GloboTicket.TicketManagement.Persistence
{
    ...
    {
        public readonly ILoggedinUserService loggedinUserService;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //modelBuilder.Entity<Category>().HasData(new Category() { CategoryId = new Guid(), Name = "Concerts" });
            //modelBuilder.Entity<Category>().HasData(new Category() { CategoryId = new Guid(), Name = "Musicals" });
        }
